...
const EMPTY = { query: '', providerFilter: null };
 ...
 */
export function readPickerUiState(storage = typeof localStorage === 'undefined' ? undefined : localStorage, key = PICKER_UI_STORAGE_KEY) {
 ...
 * @param key - storage key.
 */
export function writePickerUiState(state, storage = typeof localStorage === 'undefined' ? undefined : localStorage, key = PICKER_UI_STORAGE_KEY) {
    if (storage === undefined)
        return;
    try {
...
//# sourceMappingURL=picker-ui-state.js.map